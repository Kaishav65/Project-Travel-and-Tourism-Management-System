...
public class BookHotel extends JFrame {
    ...
    public BookHotel(String username) {
        ...
        la1.setBounds(430,100,450,300);
        add(la1);

        JLabel lblName = new JLabel("BOOK HOTEL");
        lblName.setFont(new Font("Yu Mincho", Font.PLAIN, 20));
        lblName.setBounds(118, 2, 300, 53);
        ...
        c1.setBounds(271, 100, 150, 30);
        add(c1);

        JLabel la3 = new JLabel("Total Persons");
        la3.setBounds(35, 130, 200, 14);
        contentPane.add(la3);

        t1 = new JTextField();
        t1.setText("");
        t1.setBounds(271, 130, 150, 20);
        contentPane.add(t1);
        t1.setColumns(10);

        JLabel la4 = new JLabel("Number of Days");
        la4.setBounds(35, 170, 200, 14);
        contentPane.add(la4);

        t2 = new JTextField();
        t2.setText("");
        t2.setBounds(271, 170, 150, 20);
        contentPane.add(t2);
        t2.setColumns(10);

        JLabel la5 = new JLabel("AC / Non-AC");
        la5.setBounds(35, 210, 200, 14);
        contentPane.add(la5);

        c2 = new Choice();
        c2.add("AC");
        c2.add("Non-AC");
        c2.setBounds(271, 210, 150, 30);
        add(c2);


        JLabel la6 = new JLabel("Food Included :");
        la6.setBounds(35, 250, 200, 14);
        contentPane.add(la6);

        c3 = new Choice();
        c3.add("Yes");
        c3.add("No");
        c3.setBounds(271, 250, 150, 30);
        add(c3);

        JLabel lbl1 = new JLabel("ID :");
        lbl1.setBounds(35, 280, 200, 14);
        contentPane.add(lbl1);

        JLabel l2 = new JLabel();
        l2.setBounds(271, 280, 200, 14);
        contentPane.add(l2);

        JLabel lbl2 = new JLabel("Number :");
        lbl2.setBounds(35, 310, 200, 14);
        ...
        lbl3.setBounds(35, 340,7200, 14);
        contentPane.add(lbl3);

        JLabel l4 = new JLabel();
        l4.setBounds(271, 340, 200, 14);
        contentPane.add(l4);


        JLabel lblDeposite = new JLabel("Total Price :");
        lblDeposite.setBounds(35, 370, 200, 14);
        contentPane.add(lblDeposite);

        JLabel l5 = new JLabel();
        l5.setBounds(271, 370, 200, 14);
